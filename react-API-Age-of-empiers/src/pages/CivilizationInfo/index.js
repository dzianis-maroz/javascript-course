...
const linkFromData = (arr) => {
  return arr[0].split('/').pop();
}
                  ...
                  <div className = 'flex-wrapper'>
                          {
                              Boolean(unique_unit) &&
                                  <div>
                                      <p>Unique unit</p>
                                      <Link to = {`/unit/${linkFromData(unique_unit)}`}><img alt='unit' src = {uniqueUnitIcon}/></Link>
                                  </div>
                          }
                      
                          {
                              Boolean(unique_tech) &&
                                  <div>
                                      ...
                                      <Link to = {`/technology/${linkFromData(unique_tech)}`}><img alt='tech' src = {uniqTechIcon}/></Link>
                                  </div>
                          }
                  </div>
